...
func (q *Queries) GetTransfersByToAccountID(ctx context.Context, fromAccountID int32) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, getTransfersByToAccountID, fromAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
